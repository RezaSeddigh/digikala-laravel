                ...
                <table class="table table-bordered">
                    ...
                    @foreach($countries as $country)
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="action-btns">
                                    <a href="javascript:void(0);" wire:confirm="ایا مطمعن هستید؟" wire:click="delete({{$country->id}})" class="action-btn btn-delete bs-tooltip" data-toggle="tooltip" data-placement="top" title="Delete">
