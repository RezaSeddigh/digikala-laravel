        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="orders" data-bs-parent="#accordionExample">
                    <li>
                        <a class="badge badge-light-warning" href=""> کل سفارشات </a>
                    </li>
                    <li>
                        <a class="badge badge-light-secondary" href=""> Pending </a>
                    </li>
                    <li>
                        <a class="badge badge-light-info" href=""> Processing </a>
                    </li>
                    <li>
                        <a class="badge badge-light-success" href=""> Completed </a>
                    </li>
                    <li>
                        <a class="badge badge-light-danger" href=""> Canceled </a>
                    </li>
                </ul>
            </li>
            <li class="menu">
            ...
            <li class="menu">
                <a href="{{route('admin.payment')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                             stroke-linejoin="round" class="feather feather-airplay">
            ...
            <li class="menu">
                <a href="{{route('admin.delivery')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                             stroke-linejoin="round" class="feather feather-airplay">
            ...
            <li class="menu">
                <a href="{{route('admin.category')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <li class="menu">
                <a href="{{route('admin.country')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                             stroke-linejoin="round" class="feather feather-map">
            ...
            <li class="menu">
                <a href="{{route('admin.state')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <li class="menu">
                <a href="{{route('admin.city')}}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                             stroke-linejoin="round" class="feather feather-airplay">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="setting" data-bs-parent="#accordionExample">
                    <li>
                        <a class="badge badge-light-success" href="./element-alerts.html"> تنظیمات اصلی سایت </a>
                    </li>
                    <li>
                        <a class="badge badge-light-secondary" href="./element-avatar.html">  تظیمات فوتر</a>
                    </li>
                    <li>
                        <a class="badge badge-light-info" href="./element-avatar.html">مدیریت بنر های اصلی</a>
                    </li>
                </ul>
            </li>
        </ul>
