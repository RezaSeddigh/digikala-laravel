                ...
                <table class="table table-bordered">
                    ...
                    @foreach($states as $state)
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="action-btns">
                                    <a href="javascript:void(0);"  wire:confirm="آیا مطمعن هستید؟"   wire:click="delete({{$state->id}})"  class="action-btn btn-delete bs-tooltip" data-toggle="tooltip" data-placement="top" title="Delete">
