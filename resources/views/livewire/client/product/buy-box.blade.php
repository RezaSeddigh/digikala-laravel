    ...
    <div class="bg-light border rounded-4 p-3 p-lg-3 mb-3">
        ...
        @if(\Illuminate\Support\Facades\Auth::check())
            ...
            @else
                ...
                <buatton wire:click="addToCart"
                         class="d-none d-lg-block bg-info w-100 rounded-2 border-0 mt-3 py-3 text-center  fs-8">
                    موجود در سبد خرید

                    <a href="{{route('client.cart.index')}}">(مشاهده)</a>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="fs-8">
                            این کالا در انبار دیجی‌کالا موجود و آماده پردازش است و توسط پیک دیجی‌کالا در بازه انتخابی
                            ارسال
                            خواهد شد.
                        </p>
