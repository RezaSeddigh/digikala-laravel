<div>
    ...
    <section class="my-lg-5 row mx-lg-5">
        ...
        <!-- === Seller Detail === -->
        <livewire:client.product.buy-box :sellerName="$product->seller->name" :productId="$product->id" :price="$product->price" :discount="$product->discount" :finalPrice="$product->finalPrice"/>
    </section>
    ...
    <livewire:client.product.tabs :name="$product->name" :productId="$product->id"/>
